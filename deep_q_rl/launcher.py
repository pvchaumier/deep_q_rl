...
# 
    ...
    network1 = q_network.DeepQLearner(defaults.RESIZED_WIDTH,
                                      ...
                                      rng)
    network3 = q_network.DeepQLearner(defaults.RESIZED_WIDTH,
                                      defaults.RESIZED_HEIGHT,
                                      num_actions,
                                      parameters.phi_length,
                                      parameters.discount,
    ...
    agent1 = ale_agent.NeuralAgent(network1,
    ...
    agent3 = ale_agent.NeuralAgent(network3,
                                   parameters.epsilon_start,
                                   parameters.epsilon_min,
                                   parameters.epsilon_decay,
                                   parameters.replay_memory_size,
    ...
    experiment = ale_experiment.ALEExperiment(ale, agent1, agent3,
